...
@section('content')
    ...
    <div class="content">
        ...
        <?php
            //print data
            ?> <table class="product" style="margin: 30px 110px"><tr class="image_productDetailPage"> <?php
            while ($detail= mysqli_fetch_array($PSetResult1)){ ?>
                <td style="padding: 5px 15px"><img src="<?php echo $detail['image_url'] ?>" width="auto" height="200"></td>
            <?php };
            ...
            ?> </tr>
                ...
                <tr class="category_productDetailPage"><td style="padding: 5px 15px">Category:</td><td style="padding: 5px 15px"><?php echo $detail['category'] ?></td></tr>
                ...
                <tr class="description_productDetailPage" rowspan="10"><td style="padding: 5px 15px">Descriptions:</td> <?php
            while ($detail= mysqli_fetch_array($PSetResult3)){ ?>
                <td style="padding: 5px 15px"><?php echo $detail['detail_description'] ?></td>
            <?php };
            ?> </tr></table> <?php
            //echo $output;
        ?>
