...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        ...
        <!-- <a href="{{ url('/productList') }}" class="text-sm text-gray-700 dark:text-gray-500 underline">Product</a> -->
            @if (Route::has('login'))
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                <div class="flex justify-center pt-8 sm:justify-start sm:pt-0">
                    <!-- <svg viewBox="0 0 651 192" fill="none" xmlns="http://www.w3.org/2000/svg" class="h-8 w-auto text-gray-700 sm:h-20">
...
<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
	 viewBox="0 0 189.948 189.948" class="h-8 w-auto text-gray-700 sm:h-20" style="enable-background:new 0 0 189.948 189.948;" xml:space="preserve">
<g>
	<g>
		<g>
                            ...
                            <div class="flex">
                                <svg fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor" class="-mt-px w-5 h-5 text-gray-400">
                                    <path d=""></path>
                                        ...
                                        <br>
                                        <br>
                                <a href="{{ url('/productList') }}" class="ml-1 underline">
                                    Product
                                </a>
                            </div>
                            <div class="flex">
                                <svg fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor" class="-mt-px w-5 h-5 text-gray-400">
                                    <path d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z"></path>
                                        ...
                                        <br>
                                        <br>
                                <a href="http://localhost:8000/login" class="ml-1 underline">
                                    Shop
                                </a>
                            </div>
                        </div>
